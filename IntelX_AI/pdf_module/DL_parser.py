...
def licence_parser_model(image_path: str) -> dict:
    ...
    PROMPT = """
    You are given an image of a Driving Licence along with its extracted raw text and position information (the origin [0,0] is the lower-left corner of the image).
...
def PAN_parser_model(image_path: str) -> dict:
    ...
    PROMPT = """
    You are given an image of a PAN ID card along with its extracted raw text and position information (the origin [0,0] is the lower-left corner of the image).
